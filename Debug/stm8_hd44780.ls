 ...
 519  00d6 4b01          	push	#1
 520  00d8 ae501e        	ldw	x,#20510
 ...
 710  0154 4b01          	push	#1
 711  0156 ae501e        	ldw	x,#20510
 ...
 816  01a5 4b40          	push	#64
 817  01a7 ae500f        	ldw	x,#20495
 818  01aa cd0000        	call	_GPIO_WriteHigh
 820  01ad 84            	pop	a
 822  01ae 2009          	jra	L542
 823  01b0               L342:
 826  01b0 4b40          	push	#64
 827  01b2 ae500f        	ldw	x,#20495
 ...
 839  01bf 4b20          	push	#32
 840  01c1 ae500f        	ldw	x,#20495
 841  01c4 cd0000        	call	_GPIO_WriteHigh
 843  01c7 84            	pop	a
 845  01c8 2009          	jra	L152
 846  01ca               L742:
 849  01ca 4b20          	push	#32
 850  01cc ae500f        	ldw	x,#20495
 ...
 862  01d9 4b01          	push	#1
 863  01db ae5014        	ldw	x,#20500
 864  01de cd0000        	call	_GPIO_WriteHigh
 866  01e1 84            	pop	a
 868  01e2 2009          	jra	L552
 869  01e4               L352:
 872  01e4 4b01          	push	#1
 873  01e6 ae5014        	ldw	x,#20500
 ...
 885  01f3 4b02          	push	#2
 886  01f5 ae500a        	ldw	x,#20490
 887  01f8 cd0000        	call	_GPIO_WriteHigh
 889  01fb 84            	pop	a
 891  01fc 2009          	jra	L162
 892  01fe               L752:
 895  01fe 4b02          	push	#2
 896  0200 ae500a        	ldw	x,#20490
 ...
 954  020c 4b40          	push	#64
 955  020e ae500f        	ldw	x,#20495
 ...
 970  021f 4b20          	push	#32
 971  0221 ae500f        	ldw	x,#20495
 ...
 986  0232 4b01          	push	#1
 987  0234 ae5014        	ldw	x,#20500
...
1002  0245 4b02          	push	#2
1003  0247 ae500a        	ldw	x,#20490
...
1057                     ; 177 	LCD_E_H;
1059  025d 4b08          	push	#8
1060  025f ae500a        	ldw	x,#20490
...
1077  026e               L313:
1078                     ; 179 	LCD_E_L;
1080  026e 4b08          	push	#8
1081  0270 ae500a        	ldw	x,#20490
...
1151                     ; 185 	LCD_RS_L;
1153  0281 4b01          	push	#1
1154  0283 ae501e        	ldw	x,#20510
...
1250                     ; 196 	LCD_RS_H;
1252  02ab 4b01          	push	#1
1253  02ad ae501e        	ldw	x,#20510
...
1356                     ; 208 	LCD_RS_L;
1358  02d5 4b01          	push	#1
1359  02d7 ae501e        	ldw	x,#20510
...
1387  02f2               L773:
1388                     ; 212 	LCD_E_H;
1390  02f2 4b08          	push	#8
1391  02f4 ae500a        	ldw	x,#20490
...
1419                     ; 215 	LCD_E_L;
1421  030d 4b08          	push	#8
1422  030f ae500a        	ldw	x,#20490
...
1439  031e               L704:
1440                     ; 217 	LCD_E_H;
1442  031e 4b08          	push	#8
1443  0320 ae500a        	ldw	x,#20490
...
1468                     ; 220 	LCD_E_L;
1470  0336 4b08          	push	#8
1471  0338 ae500a        	ldw	x,#20490
...
1537                     ; 230 LCD_RS_H;
1539  0358 4b01          	push	#1
1540  035a ae501e        	ldw	x,#20510
1541  035d cd0000        	call	_GPIO_WriteHigh
1543  0360 84            	pop	a
1544                     ; 231 LCD_RW_H;
1546  0361 4b04          	push	#4
1547  0363 ae500a        	ldw	x,#20490
...
1593  0370 ae500a        	ldw	x,#20490
1594  0373 cd0000        	call	_GPIO_WriteLow
1596  0376 84            	pop	a
1597                     ; 238 LCD_D4_H;
1599  0377 4b40          	push	#64
1600  0379 ae500f        	ldw	x,#20495
1601  037c cd0000        	call	_GPIO_WriteHigh
1603  037f 84            	pop	a
1604                     ; 239 LCD_D5_H;
1606  0380 4b20          	push	#32
1607  0382 ae500f        	ldw	x,#20495
1608  0385 cd0000        	call	_GPIO_WriteHigh
1610  0388 84            	pop	a
1611                     ; 240 LCD_D6_H;
1613  0389 4b01          	push	#1
1614  038b ae5014        	ldw	x,#20500
1615  038e cd0000        	call	_GPIO_WriteHigh
1617  0391 84            	pop	a
1618                     ; 241 LCD_D7_H;
1620  0392 4b02          	push	#2
1621  0394 ae500a        	ldw	x,#20490
